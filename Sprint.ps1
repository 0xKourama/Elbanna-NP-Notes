...
$Quotes = @(
    ...
    "ربي أوزعني أن أشكر نعمتك التي أنعمت علي وعلى والدي وأن أعمل صالحا ترضاه وأدخلني برحمتك في عبادك الصالحين",
    "و مالنصر الا من عند الله",
    "ولقد نصركم الله ببدر و كنتم اذلة",
    "ان الله يحب اذا عمل احدكم عملا ان يتقنه",
    "هل يستوي اللذين يعملون و اللذين لا يعملون؟",
    "ان الله لا يضيع اجر من احسن عملا",
    "انا فتحنا لك فتحا مبينا",
    "ان يعلم الله في قلوبكم خيرا يؤتكم خيرا منه",
    "ان ينصركم الله فلا غالب اكم و ان يخذلكم فمن ذا الذي ينصركم من بعده و علي الله فليتوكل المؤمنون",
    "Never stop exploring - Unknown",
    "In a world of conflict, it is tempting to build up one's defenses and go around in a suit of armor. But there's a problem with that. A suit of armor protects you by containing you. You can only grow so much, and then you have to get out of your armor if you want to grow any further. - Do It Anyway"
    "It is hard to judge what will happen when you give your best. You will probably be appreciated and supported. But giving your best may also result in a backlash of jealousy and rivalry. You may be accused of selfish ulterior motives; you may win false friends and true enemies; you may be shot down by small men and women with small minds; you may witness the destruction of what you spent years building; you may be attacked by those you are helping; you may be left to fight the good fight alone. - Do It Anyway"
    "My master, expend your effort and keep on progressing, you are a competent man and your service is greatly required - Unknown",
    "This is the life you are given. Your job is to make the most of it. It doesn't matter what the world does in response. Personal meaning comes from giving the world your best, no matter what - Do it Anyway",
    "Give the world the best you have and you'll get kicked in the teeth. Give the world the best you have anyway - Do It Anyway",
    "True skills comes without effort - Crouching Tiger Hidden Dragon"
    "Never forget where you came from - Unknown",
    "Handle your spiral, keep your charge, your head down and always go forward - Unknown"
