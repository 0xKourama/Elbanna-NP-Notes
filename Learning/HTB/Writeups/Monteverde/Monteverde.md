...
The researcher and log author **"Adam Chester"** had thankfully created a script that takes care of all the above and dumps us the stored credentials *if we have access to the database.*
